...
-->
    ...
    {{-- search starts Here --}}
      <div style="" class="text-center p-3">
        <form class="" action="{{url('/search_women_products')}}" method="get">
          @csrf
    ...
    <section class="section" id="products">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        <h2>Our Latest Women Products</h2>
        ...
        <div class="container">
            <div class="row">
              @if(count($all_women)>0)
              @foreach($all_women as $product)
                <div class="col-lg-4">
                    <div class="item">
                        <div class="thumb">
            ...
            @else
                <div style="margin:auto" class="">
                   <h3 style="font-family:verdana;">No match found</h3>
                </div>
            @endif
