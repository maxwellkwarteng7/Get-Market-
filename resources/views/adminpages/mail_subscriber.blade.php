        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row col-lg-8">
                <div class="card">
                  <div class="card-body">
                    <h3 class="card-title">Send subscriber a mail</h3>
                    <h2 class="p-3">Send mail to {{$subscriber->email}}</h2>
                    <form class="" action="{{url('send_subscriber_mail',$subscriber->id)}}" method="post">
                      @csrf
                      ...
                      <div class="col-lg-5 p-2">
                          <label>Link</label>
                          <input type="url" name="link" placeholder="eg: https//:youtube.com" required>
                      </div>
